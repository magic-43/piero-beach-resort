...
export default async function PieroDashboardPage() {
  await requireAdmin();
                    ...
                    <div className="divide-y divide-gray-50">
                      {groupedSubmissions[dateStr].map((sub) => {
                        ...
                        return (
                          <Link
                            key={sub.id}
                            href={`/admin/piero/payments/${booking?.reference}`}
                          ...
                          >
                            ...
                            <div className="text-right shrink-0">
                              <p className="text-[14px] font-bold text-emerald-600 tracking-tight">+₱{Number(sub.amount_claimed).toLocaleString()}</p>
                  ...
                  return (
                    <tr key={sub.id} className="hover:bg-gray-50/50 transition-colors">
                      <td className="py-4 px-6">
                        <Link href={`/admin/piero/payments/${booking?.reference}`} className="font-medium hover:text-[#c4a47c] transition-colors">
                          {booking?.guest_name}
                        </Link>
                      </td>
