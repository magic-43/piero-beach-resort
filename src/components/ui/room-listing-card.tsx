...
export function RoomListingCard({
  ...
  const discountPercentage = Math.round(((regularPrice - discountedPrice) / regularPrice) * 100);
        ...
        <div>
          ...
          <div className="mt-6">
            <div className="flex items-baseline flex-wrap mb-4">
              ...
              <span className="text-sm line-through text-resort-cocoa/40 font-normal mr-2.5">₱{regularPrice.toLocaleString()}</span>
              <span className="font-serif text-3xl font-bold text-[#132c4a]">₱{discountedPrice.toLocaleString()}</span>
